	...
	var oprDirect = new JqueryAjaxDirect({
		services : {
			editSsid : function(options){
				var url = "${base}cpe/updateSsid.do",
                    ...
                    <td class="mc_col">
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="oldSsid" value="${ssid.name}" />
                                <div class="section first">
                                	编辑设备【${host.name}】的 WiFi 网络配置。
                                </div>
                                <div class="section">
                                    <h3>网络开关</h3>
                                    <p class="p5">
                                ...
                                <div id="netEnabledSection">
                                    <div class="section">
                                        ...
                                        <p class="p10">
                                            ...
                                            -->
                                            <span><input name="ssid" id="field_ssid" dataType="Require" class="field" value="${ssid.name}" autocomplete="off" /> <span class="warn">*</span> </span> <span class="desc">例： 广州酒家-上下九店</span>
                                        </p>
                                        <p class="p10">
                                           <input type="checkbox" name="useSsidPolicy" class="field_selector" id="field_useSsidPolicy" value="1" ${ssid.codeId>0?'checked':''}/><label class="selector_label" for="field_useSsidPolicy">使用 SSID 策略 <span class="soof_need_tooltip" title="SSID 名称在策略里定义，当更新某一个策略的 SSID 名称时，所有应用该策略的设备的 SSID 名称都同步更新。"><i class="soof_icon help"></i></span></label>
                                        </p>
                                    ...
                                    <div class="section">
                                        <h3>认证策略</h3>
                                        <p class="p5">设置用户访问您的 WiFi 时的认证策略：如认证方式，访问控制等。</p>
                                        <p class="p10">
