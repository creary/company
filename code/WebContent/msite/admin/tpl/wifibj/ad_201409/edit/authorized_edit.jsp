...
<div id="adImageEditor" class="soof_page" style=" display:none; width:600px; height:200px;">
    <div style="padding:2em;">
        <div class="section first">
            <h3>图片文件</h3>
            <p class="p5">
            	文件大小不超过 1MB；格式为 png、jpg、gif；设计师建议的大小为：宽 500 像素，高度不限，但各图片间应尽量保持一致。
            </p>
            <p class="p10">
                <img id="editingAdImage" src="" style="width:200px; height:100px;" align="top" />
...
<div class="section">
    <h3>主广告区</h3>
    <p class="p5">
    	显示在 logo 下方的广告图片，可添加多个，拖动图片可排序。
	</p>
    <div class="ad_images_ctn">
        <ul id="adImages_editor" class="soof_editable_cards p10">
