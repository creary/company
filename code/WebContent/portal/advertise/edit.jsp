	...
	var articleDirect = new JqueryAjaxDirect({
		services : {
			update : function(options){
				var url = "${base}portal/advertiseUpdate.do",
                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" autocomplete="off" onsubmit="return false;">
                                ...
                                <div class="section">
                                    ...
                                    <p class="p10">
                                    	<input name="title" maxlength="150" class="field l" dataType="Require" value="${dto.title}" /> <font color="red">*</font>
                                    </p>
                                </div>
                                <div class="section">
                                    <h3>封面图片</h3>
                                    ...
                                    <div class="p10">
                                        <div class="cover_img_ctn">
                                            <input type="hidden" id="coverField" name="cover" value="${dto.cover}" />
                                            <img src="${dto.cover}" id="cover" class="cover" />
                                    ...
                                    <p class="p10">
                                        <select name="categoryId" class="field"> 
                                            ...
                                            <c:forEach items="${cates}" var="cate">  
                                                 <option value="${cate.id}" ${dto.categoryId==cate.id?"selected='selected'":""}>${cate.name}</option>  
                                            </c:forEach> 
                                        </select>                    
                                    </p>
                                </div>
                                <div class="section">
                                    ...
                                    <p class="p10">
                                    	<textarea name="summary" id="summaryField" style="width:800px;" class="field" onfocus="this.style.height='50px';" onblur="this.style.height='';">${dto.summary}</textarea>
                                    </p>
                                </div>
                                <div class="section">
                                    <h3>正文</h3>
                                    <p class="p10">
                                    	<textarea name="clobs_text" id="clobsText" style=" height:400px; width:800px;">${dto.content}</textarea>
                                    </p>
                                </div>
