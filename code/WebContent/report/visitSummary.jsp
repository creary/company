...
orderjs(function(){
    ...
    rl.onReady(function(){
		...
		reportUtil.createLoader({
			url : "${base}report/getVisitPie.do?flag=province",
			view : "#detectBrandsStatWrapper"
		},{
			url : "${base}report/getVisitPie.do?flag=realm",
	...
	<div class="soof_page_viewport">
    	<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
            <div class="soof_header">
                <h1 style="display:inline-block;">访问统计</h1>
                <p class="p10 desc">对终端用户访问进行统计。</p>
            </div>
            <div class="soof_body">
