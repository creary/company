...
orderjs(function(){
    ...
    rl.onReady(function(){
		...
		reportUtil.createLoader({
			url : "${base}report/getEndUserBar.do?flag=merchant&branchId=${branchId}",
	...
	<div class="soof_page_viewport">
    	<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
            <div class="soof_header">
                <h1 style="display:inline-block;">商家接入用户数统计</h1>
                <p class="p10 desc">对商家接入用户（MAC地址）数进行统计。</p>
            </div>
            <div class="soof_body">
                ...
                <div class="section section_unite">
                    <div class="s_header">
                        <span class="title">商家接入用户数Top10</span>
                    </div>
