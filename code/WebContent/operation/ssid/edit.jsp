...
<head>
<title>编辑 SSID 策略【${dto.name}】</title>
...
orderjs(function(){
	...
	function doAction() {
		...
		if (rlx.mti.validate(mainForm)) {
			mainForm.action = "${base}cpe/ssidCodeUpdate.do";
       ...
       <div class="group">
           <table border="0" class="grid_fields grid_fields_cols4">
               ...
               <tr>
                   ...
                   <td class="field_ctn">
                   		支持中英文，中间不能有空格。<br />
                        <span><input name="ssid" id="field_ssid" dataType="Require" class="field" value="${dto.ssid}" /> <font color="red">*</font> </span> <br />
