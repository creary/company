...
<body class="fullscreen soof_mui theme_darkblue">
    ...
    <div id="muiHeader" class="mui_header">
        ...
        <div class="user_bar">
            ...
            <a class="btn" href="${base}<c:url value='j_spring_security_logout' />"><span class="soof_icon exit_white"></span> 退出</a>
        </div>
    </div>
        ...
        <div class="mui_side">
            <div class="soof_mui_menu" id="mainMenu">
                <ul class="menu_holder">
                    <li>
                        <img src="${base}resources/image/default/mix/blank.gif" class="indent_icon" border="0" /><a id="startpage" href="${base}home/soofacHome.do" target="mainFrame" class="ctg icon_home"><div class="text">平台概览</div></a>
                    </li>
                    <li>
                        <img src="${base}resources/image/default/mix/blank.gif" class="fold_icon" border="0" /><a href="javascript:void(0);" class="ctg icon_server"><div class="text">商家管理</div></a>
                        <ul class="sub_list">
                            <li><a id="admin_merchant" href="${base}admin/branchListJsp.do" target="mainFrame">商家管理</a></li>
                            <li><a id="admin_smsList" href="${base}portal/smsListJsp.do" target="mainFrame">已发短信</a></li>
                            <li><a id="admin_branchUserList" href="${base}admin/userListJsp.do" target="mainFrame">帐号管理</a></li>
                        </ul>
                    </li>
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon" border="0" /><a href="javascript:void(0);" class="ctg icon_wifi_device"><div class="text">设备管理</div></a>
                        <ul class="sub_list">
                            ...
                            <li><a id="cpe_firmwareFileList" href="${base}cpe/softListJsp.do" target="mainFrame">固件管理</a></li>  
                            <li><a id="cpe_configFileList" href="${base}cpe/softListJsp.do?tag=2" target="mainFrame">配置管理</a></li>
                        </ul>
                    </li>   
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon" border="0" /><a href="javascript:void(0);" class="ctg icon_wifi_user"><div class="text">用户管理</div></a>
                        <ul class="sub_list">	
                            <li><a id="surfing_user" href="${base}portal/surfingAccountListJsp.do" target="mainFrame">用户列表</a></li>
