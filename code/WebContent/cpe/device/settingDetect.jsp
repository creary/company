                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                ...
                                <div class="section">
                                    <h3>探测开关</h3>
                                    <p class="p10">
                                        <input type="radio" name="monitor" class="field_selector" value="off" ${!turnOnDetect?"checked":""} id="field_turnOnMonitor" /><label class="selector_label" for="field_turnOnMonitor">关闭（默认）</label>&nbsp;&nbsp;
                                        <input type="radio" name="monitor" class="field_selector" value="on" ${turnOnDetect?"checked":""} id="field_turnOffMonitor" /><label class="selector_label" for="field_turnOffMonitor">开启</label>
                                    </p>
                                </div>
                                <div id="monitorOnSection" style="display:none;">
                                    ...
                                    <div class="section">
                                        ...
                                        <p class="p10">
                                            <input name="enterSnr" id="field_dataServer" class="field" value="${enterSnr}" />
                                        </p>
                                    </div>
                                </div>
