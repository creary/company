...
orderjs(function(){
	...
	function doAction() {
	   ...
	   if (rlx.mti.validate(mainForm)) {
		   mainForm.action = "${base}/cpe/propertySave.do";
     ...
     <div class="group">
        <table border="0" class="grid_fields grid_fields_cols4">
           ...
           <tr>
               ...
               <td class="field_ctn">
                   <input class="field" name="cnName" dataType="Require" msg="必填项" /><font color="red">*</font>
               </td>               
               <th class="label">英文</th>
               <td class="field_ctn">
                   <input class="field" name="enName" dataType="Require" msg="必填项" /><font color="red">*</font>
               </td>               
           </tr>    
           <tr>
               <th class="label">描述</th>
               <td class="field_ctn" colspan="3">
                   <input class="field" name="descr"/>
               </td>               
           </tr>    
        </table>
     </div>
