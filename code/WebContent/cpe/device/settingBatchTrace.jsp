                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                ...
                                <div class="section">
                                    ...
                                    <p class="p10">
                                        <input type="radio" name="MonURLType" class="field_selector" value="off" id="field_MonURLType_off" /><label class="selector_label" for="field_MonURLType_off">关闭（默认）</label>&nbsp;&nbsp;
                                        <input type="radio" name="MonURLType" class="field_selector" value="trace" id="field_MonURLType_trace" /><label class="selector_label" for="field_MonURLType_trace">开启溯源</label>&nbsp;&nbsp;
                                    </p>
                                </div>
