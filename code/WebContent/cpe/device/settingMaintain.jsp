                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                ...
                                <div class="section first">
                                    ...
                                    <p class="p10">
                                        <input type="radio" name="autoReboot" class="field_selector" value="0" id="field_autoReboot_off" ${autoReboot==0?"checked":""}/><label class="selector_label" for="field_autoReboot_off">关闭（默认）</label>&nbsp;&nbsp;
                                        <input type="radio" name="autoReboot" class="field_selector" value="1" id="field_autoReboot_on" ${autoReboot==1?"checked":""}/><label class="selector_label" for="field_autoReboot_on">开启</label>
                                    </p>
                                </div>
                                <div id="autoRebootOnSection" style="display:none;">
                                    <div class="section">
                                        ...
                                        <div class="p10" id="weekHourCtn">
                                        	<input type="hidden" name="rebootWeekHour" value="${bits}" />
                                        </div>
                                    </div>
                                </div>
