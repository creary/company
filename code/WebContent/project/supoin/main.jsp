            ...
            <div class="soof_mui_menu" id="mainMenu">
                <ul class="menu_holder">
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        ...
                        <ul class="sub_list" style="display:none;">	
                            <li><a id="cpe_hostList" href="cpe/hostListJsp.do" target="mainFrame">设备列表</a></li>
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        ...
                        <ul class="sub_list" style="display:none;">	
                            ...
                            <li><a id="marketing_wechat" href="${base}admin/readyEditWechatBase.do?branchId=${branchId}" target="mainFrame">微信认证</a></li>
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        ...
                        <ul class="sub_list" style="display:none;">	
                            ...
                            <li><a id="surfing_sessionList" href="${base}portal/sessionListJsp.do" target="mainFrame">上网日志</a></li>
                            <li><a id="surfing_sessionList" href="${base}detect/traceFlowListJsp.do" target="mainFrame">溯源信息</a></li>                            
