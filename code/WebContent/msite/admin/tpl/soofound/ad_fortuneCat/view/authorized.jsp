...
<body class="msite_page_authorized">
    <div class="soof_ad_tlayout">
        <div class="header">
            <a href="${topAdHref}"><img class="banner" alt="" src="${topAdImage}" /></a>
        </div>
        <div class="mc">
            ...
            <div class="big_ad" style="width:92%; margin:0 auto;">
            	<a href="${bigAdHref}"><img class="banner" alt="" src="${bigAdImage}" /></a>
            </div>
