...
orderjs(function(){
	...
	function doAction() {
	   ...
	   if (rlx.mti.validate(mainForm)) {
		   ...
		   mainForm.action = "${base}cpe/configSave.do";
       ...
       <div class="group">
           <table border="0" class="grid_fields grid_fields_cols4">                
               ...
               <tr>
				  ...
				  <td class="field_ctn">
					  <input class="field" name="descr" style="width:190px" dataType="Require" msg="必填项" /><font color="red">*</font>	 
				  </td>
			   </tr>
               <tr>
               ...
               <tr>
				  ...
				  <td class="field_ctn">
					  <input name="version" type="checkbox" value="default" />
                         ...
                         <table border="0" class="grid_fields">
                            <c:forEach items="${props}" var="prop" varStatus="item">
	                            <tr>
	                                ...
	                                <td class="field_ctn">
                                           <input type="checkbox" class="field_selector" name="props" id="propField_${item.index}" value="${prop.id}" />
