...
<script type="text/javascript" data-main="RealLight" data-rlconfig="{autoLoadLang:false}" src="${jsPath}rl/src/order.js"></script>
        ...
        orderjs(function(){
			...
			prerollPlayer
				.setSource(new AdSource({
					content : '<img class="img_preroll_holder" src="${picAdImage}" />'
				}))
				.load();
