	...
	var announcementDirect = new JqueryAjaxDirect({
		services : {
			save : function(options){
				var url = "${base}admin/announcementUpdate.do",
                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" autocomplete="off" onsubmit="return false;">
                                ...
                                <div class="section first">
                                    ...
                                    <p class="p10">
                                    	<input name="title" maxlength="100" class="field l" dataType="Require" value="${dto.title}" /> <font color="red">*</font>
                                    </p>
                                </div>
                                <div class="section">
                                    <h3>正文</h3>
                                    <p class="p10">
                                    	<textarea name="content" id="field_content" style=" height:300px; width:800px;">${dto.content}</textarea>
                                    </p>
                                </div>
