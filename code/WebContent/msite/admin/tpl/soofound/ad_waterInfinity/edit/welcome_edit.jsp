    ...
    <div id="bannerImageEditor" class="soof_page" style=" display:none; width:600px; height:250px; overflow:auto;">
        <div style="padding:2em;">
            ...
            <div class="section">
                ...
                <p class="p10">
                    <input class="field" id="editingBannerImageHref" /> <span class="desc">(可不填)</span>
                </p>
...
<div id="picWallEditSection">
    ...
    <div id="picWallImageEditor" class="soof_page" style=" display:none; width:600px; height:250px; overflow:auto;">
        <div style="padding:2em;">
            <div class="section first">
                <h3>图片文件</h3>
                <p class="p5">
                    文件大小不超过 1MB；格式为 png、jpg、gif；设计师建议的大小为：250 * 125 像素。
                </p>
                <p class="p10">
                    <div class="soof_img_viewer" style="width:250px">
                        <input type="hidden" id="field_file" name="file" />
            ...
            <div class="section">
                ...
                <p class="p5">用户点击图片时，打开的页面 URL（以 http:// 或 https:// 开头）。</p>
                <p class="p10">
                    <input class="field" id="editingPicWallImageHref" /> <span class="desc">(可不填)</span>
                </p>
                <p class="warn p5">由于用户此时尚未通过认证，还不能上外网，因此您需要将 URL 中的域名添加到设备的白名单，否则当用户点击链接时，该链接会被拦截，无法正常访问。</p>
            </div>
        </div>
    ...
    <div class="section">
        <h3>图片墙广告</h3>
        <p class="p5">
            紧贴于横幅广告之下的图片，由 4 个等宽的图片组成。如添加超过 4 个则随机显示。
        </p>
        <div class="fields_box">
