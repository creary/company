	...
	<div class="soof_page_viewport">
    	<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
            <div class="soof_header">
                <h1 style="display:inline-block;">客流统计</h1>
                <p class="p10 desc">对顾客数进行统计分析。其中探测数为探测到的终端设备数；进店数为进入店内的终端设备数；认证数为连接 wifi 并通过认证的终端设备数。</p>
            </div>
            <div class="soof_body">
                <div class="section first">
                    ...
                    <div class="summary soof_num_cols">
                        <table id="flowSummaryStat" rl-deco="dataBinding"
                         rl-deco-options="flowSummaryViewOptions"
                         class="layout" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="cell">
                                    <table class="canvas" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="num" data-field="detectTotal">-</td>
                                ...
                                <td class="cell">
                                    <table class="canvas" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="num" data-field="enterTotal">-</td>
                                ...
                                <td class="cell">
                                    <table class="canvas" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="num" data-field="authTotal">-</td>
                        ...
                        <div rl-deco="Table" rl-deco-embedded="comp" 
                         rl-deco-options="{
                            ...
                            columns : [
                                ...
                                {caption: '进店数', name: 'enterTotal'},
                                {caption: '进店率', name: 'enterRatio'},
