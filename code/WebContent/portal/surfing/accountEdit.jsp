...
orderjs(function(){
	function doAction() {
	    ...
	    if (rlx.mti.validate(mainForm)) {
			mainForm.action = "${base}portal/surfingAccountUpdate.do";
        ...
        <div class="group">
            <table border="0" class="grid_fields grid_fields_cols4">
                <tr>
                    ...
                    <td class="field_ctn">
                         <input class="field" name="password" dataType="Require" value="${dto.password}" /><font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    <th class="label">上行带宽</th>
                    <td class="field_ctn">
                        <input class="field" name="upSpeed" dataType="Number" value="${dto.upSpeed}" /> kbps
                    </td>
                    <th class="label">下行带宽</th>
                    <td class="field_ctn">
                        <input class="field" name="downSpeed" dataType="Number" value="${dto.downSpeed}" /> kbps
                    </td>
                </tr> 
            </table>
        </div>
