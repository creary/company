...
<link href="${cssPath}msite/welcome_freego.css?_v=${cacheBuster}" rel="stylesheet" type="text/css" />
</head>
<body class="soof_welcome_freego_bg">
<jsp:include page="${moduleRoot}ScanQrcodeGuide/view/Module.jsp" />
</body>
</html>