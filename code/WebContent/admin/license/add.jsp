...
orderjs(function(){
	...
	function doAction() {
		...
		if (rlx.mti.validate(mainForm)) {
			mainForm.action = "${base}admin/licenseSave.do";
       ...
       <div class="group">
           <table border="0" class="grid_fields grid_fields_cols4">
               <tr>
                  ...
                  <td class="field_ctn">
                      <input class="field" name="mac" dataType="Required" msg="必填项" style="width:150px"/>
                      <font color="red">*</font>                      
                  </td>
               </tr>                                                                                                                                    
               <tr>
                  ...
                  <td class="field_ctn">
                      <input class="field" name="flashId" dataType="Required" msg="必填项" style="width:150px"/>
