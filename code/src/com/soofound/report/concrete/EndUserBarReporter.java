...
/*  4:   */
/*  5:   */public class EndUserBarReporter extends PieReporter
/*  6:   */{
/*  7:   */  protected String getSQL() {
/*  8: 8 */    StringBuilder sqlText = new StringBuilder(200);
/*  9: 9 */    if ("ap".equals(this.paras.get("flag"))) {
/* 10:10 */      sqlText.append("SELECT ap_name ap,COUNT(DISTINCT mac) val FROM view_surfing_session_history ");
...
/* 13:   */    } else {
/* 14:14 */      sqlText.append("SELECT branch,COUNT(DISTINCT mac) val FROM view_surfing_session_history ");
...
/* 17:   */    }
/* 18:18 */    if (this.debug)
/* 19:19 */      System.out.println("-----EndUserBarReporter------\n" + sqlText.toString());
 ...
 * Qualified Name:     com.soofound.report.concrete.EndUserBarReporter
