...
orderjs(function(){
	function doAction() {
	   ...
	   if (rlx.mti.validate(mainForm)) {
		   ...
		   mainForm.action = "${base}admin/userSave.do";
        ...
        <div class="group">
            <table border="0" class="grid_fields grid_fields_cols4">
                <tr>
                    ...
                    <td class="field_ctn"><input class="field" name="fullname" dataType="Require" msg="必填项" /><font color="red">*</font></td>
                </tr>                
                <tr>
                    <th class="label">密码</th>
                    <td class="field_ctn"><input class="field" name="password" type="password" dataType="Require" msg="必填项" />
                        <font color="red">*</font>
                    </td>
                    <th class="label">确认密码</th>
                    <td class="field_ctn"><input class="field" name="password0" type="password" dataType="Require" msg="必填项" />
                        <font color="red">*</font>
                    </td>
                </tr>
	            <tr>
                ...
                <tr>
                    ...
                    <td class="field_ctn"><input class="field" name="phone" dataType="Mobile" msg="必须是手机号" />
                    <font color="red">*</font></td>
                    <th class="label">Email</th>
                    <td class="field_ctn"><input class="field" name="email" dataType="Email" msg="必须是Email" />
                    <font color="red">*</font></td>
                </tr>                                
            </table>
        </div>
