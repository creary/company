                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                <div class="section first">
                                    <h3>素材名称</h3>
                                    <p class="p10">
                                    	<input name="name" class="field" dataType="Require" />
                                    </p>
                                </div>
                                <div class="section">
                                    <h3>图片文件</h3>
                                    ...
                                    <div class="p10">
                                        <div class="soof_img_viewer">
                                            ...
                                            <img src="" id="imgHolder" class="img_holder" style="display:none;" />
                                ...
                                <div class="section">
                                    ...
                                    <p class="p10">
                                        <input type="radio" name="linkTarget" value="_blank" class="field_selector" id="field_linkTarget_blank" checked="checked" /><label class="selector_label" for="field_linkTarget_blank">新窗口（默认）</label>&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="linkTarget" value="_self" class="field_selector" id="field_linkTarget_self"  /><label class="selector_label" for="field_linkTarget_self">原窗口</label>
                                    </p>
                                </div>
                                <div class="section">
