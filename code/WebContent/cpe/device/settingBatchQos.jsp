                        ...
                        <div class="mc_wrapper">
                            <form name="mainForm" id="mainForm" method="post" onsubmit="return false;">
                                ...
                                <div class="section">
                                    <h3>QOS 开关</h3>
                                    <p class="p10">
                                        <input type="radio" name="qos" class="field_selector" value="0" id="field_turnOnQos" /><label class="selector_label" for="field_turnOnQos">关闭（默认）</label>&nbsp;&nbsp;
                                        <input type="radio" name="qos" class="field_selector" value="1" id="field_turnOffQos" /><label class="selector_label" for="field_turnOffQos">开启</label>
                                    </p>
                                </div>
                                <div id="qosOnSection" style="display:none;">
                                    <div class="section">
                                        <h3>带宽设置</h3>
                                        <p class="p5">为了让QOS 能准确限速，请填写准确的网络带宽。</p>
                                        <p class="p10">
                                            <font color="red">*</font> 上行带宽： 
                                            <input name="qosTx" class="field s" /> kbps 
                                            <span class="desc">（最小值为 64）</span>
                                        </p>
                                        <p class="p10">
                                            <font color="red">*</font> 下行带宽： 
                                            <input name="qosRx" class="field s" /> kbps 
                                            <span class="desc">（最小值为 64）</span>
                                        </p>
                                    </div>
                                </div>
