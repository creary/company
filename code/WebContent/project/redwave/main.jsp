...
<body class="fullscreen soof_mui theme_darkblue">
    ...
    <div id="muiHeader" class="mui_header">
        <div class="logo_wrap">
            ...
            <span id="verLabel" class="ver">3.4</span>
        </div>
        <div class="user_bar">
                ...
                <ul class="menu_holder">
                    ...
                    <li>
                        ...
                        <ul class="sub_list" style="display:none;">	
                            ...
                            <li><a id="admin_branchList" href="${base}admin/branchListJsp.do" target="mainFrame">商家管理</a></li>
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        ...
                        <ul class="sub_list" style="display:none;">	
                            <li><a id="cpe_hostList" href="${base}cpe/hostListJsp.do" target="mainFrame">设备列表</a></li>
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        ...
                        <ul class="sub_list" style="display:none;">	
                            ...
                            <li><a id="surfing_employeeList" href="${base}portal/blackWhiteListJsp.do?bw=4" target="mainFrame">员工名单</a></li>                            
                        </ul>
                    </li>
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                    ...
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        <a id="probe_mgmt" href="javascript:void(0);" class="ctg icon_wifi_probe"><div class="text">探测管理</div></a>
                        <ul class="sub_list" style="display:none;">	
                            <li><a id="probe_customer" href="${base}acside/detect/flowSummary.jsp" target="mainFrame">客流统计</a></li>
                            <li><a id="probe_feature" href="${base}acside/detect/typeSummary.jsp" target="mainFrame">新老顾客</a></li>
                            <li><a id="probe_loyalty" href="${base}acside/detect/visitSummary.jsp" target="mainFrame">到访频次</a></li>                            
                            <li><a id="probe_hotspot" href="${base}acside/detect/hotspotSummary.jsp" target="mainFrame">热点铺位</a></li>
                            <li><a id="probe_customer" href="${base}acside/detect/brandSummary.jsp" target="mainFrame">终端品牌</a></li>
                            <li><a id="probe_path" href="${base}acside/detect/customerPath.jsp" target="mainFrame">行走路线</a></li>                            
                            <li><a id="probe_flow" href="${base}detect/detectFlowListJsp.do" target="mainFrame">探测流水</a></li>
                        </ul>
                    </li>
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        <a id="location_mgmt" href="javascript:void(0);" class="ctg icon_wifi_pos"><div class="text">定位管理</div></a>
                        <ul class="sub_list" style="display:none;">	
                            <li><a id="location_about" href="${base}admin/help/aboutWiFiLocation.jsp" target="mainFrame">定位管理</a></li>
                        </ul>
                    </li>            
                    <li><img src="${base}resources/image/default/mix/blank.gif" class="fold_icon fold_icon_collapsed" border="0" />
                        <a id="video_mgmt" href="javascript:void(0);" class="ctg icon_wifi_camera"><div class="text">云摄像机</div></a>
                        <ul class="sub_list" style="display:none;">	
                            <li><a id="video_about" href="${base}admin/help/aboutWiFiVideo.jsp" target="mainFrame">云摄像机</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
