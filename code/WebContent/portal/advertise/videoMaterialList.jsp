...
orderjs(function(){
	function genEdit(cellText, colIndex, rowIndex, dataSource){
		var url = "${base}portal/advertise/videoMaterialEdit.jsp?id=" + cellText;
		return '<a href="javascript:void(0);" onclick="rl.page.open(\'' + url + '\', \'videoMaterialEdit\', rl.gui.winDlgOpt);"><img src="${imagePath}edit.gif" border="0"/></a>';
	}
	...
	rlx.mti.createListPage({
			...
			items : [		
				{
					...
					action : function(){
						rl.page.open("${base}portal/advertise/videoMaterialAdd.jsp", "videoMaterialAdd", rl.gui.winDlgOpt);
					}
				},
				{
					text : "删除",
		...
		grid :{
			dataUrl : "${base}portal/materialList.do?target=video&branchId=${branchId}",
			dataFields : ["id","name", "file","description","createTime"],
            dataPrimaryKey : "id",
			autoRenderOnReady : true,
...
<div class="soof_page">
	<div class="soof_gridpage_viewport">
    	<div class="soof_header">
            ...
            <div class="nav">
                <ul class="list">
                    <li><a href="${base}portal/advertise/imageMaterialList.jsp">图片素材</a></li>
                    <li class='active'><a href="javascript:void(0);">视频素材</a></li>
                </ul>
            </div>
        </div>
        <div id="mainPanel">
