...
/* override defaults */
.main .banner_wrapper{
	background-image:url(${base}resources/project/supoin/login_banner_bg.png);
	height:355px;
}
.main .banner{
	margin-top:0;
...
<div class="main">
	<div class="banner_wrapper">
    	<div class="banner_holder" style="">
            <img class="banner" src="${base}resources/project/supoin/login_banner.png" border="0" />
            <div class="login">
                <form name="login" class="login_viewport" action="<c:url value='j_spring_security_check' />" method="post" onsubmit="return check_form()">
                    ...
                    <div id="inputs" class="inputs">
                        ...
                        <div class="inputline" style="margin-top:20px;">
                            <input type="image" tabindex="5" src="${base}resources/project/supoin/btn_login.gif" />
                        </div>                        
                    </div>
                </form>
            </div>
