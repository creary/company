	...
	rlx.mti.createTreeListPage({
		...
		tree : {
			...
			loadGridByNode : function(id){
				...
				var url = rl.format("${base}cpe/richHostList.do?branchId=${branchId}&tag=2", arguments);
		...
		grid :{
			...
			"usedText","ssidName","portalName","policyName","location"],
			dataPrimaryKey : "id",
			...
			columns : [
				...
				{caption: "SSID", name: "ssid", visible : false, colEntityTag : "operation"},							
